...
var Elm = {};
Elm['Poc'] = Elm['Poc'] || {};
if (typeof _user$project$Poc$main !== 'undefined') {
    _user$project$Poc$main(Elm['Poc'], 'Poc', {"types":{"unions":{"Poc.Msg":{"args":[],"tags":{"GreetingFromExtJS":["List String"],"Check":[],"Change":["String"],"ChangeLevel":["String"]}}},"aliases":{},"message":"Poc.Msg"},"versions":{"elm":"0.18.0"}});
}
